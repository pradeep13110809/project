...
from vehicle_service_website import views
...
urlpatterns = [
    ...
    path('mechaniclogin', LoginView.as_view(template_name='mechaniclogin.html'),name='mechaniclogin'),
    ...
    path('activate/<str:uidb64>/<str:token>/',views.mechanic_activate_view, name='activate'),

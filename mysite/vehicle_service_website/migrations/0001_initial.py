# Generated by Django 3.0.5 on 2023-04-21 05:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='vehicle_service_website.Customer')),
                ('mechanic', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='vehicle_service_website.Mechanic')),
            ],
        ),
        migrations.CreateModel(
            name='Attendance',
